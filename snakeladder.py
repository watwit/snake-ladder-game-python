...
class SnakeLadder:
    def __init__(self,canvas):
        ...
        howtobtn=Button(tk,image=howtoplayphoto,borderwidth=2,command=howtoplaybg)
        self.howtobtn=howtobtn
        
    def create_btn(self):#สร้างปุ่มสร้างรูป
        self.startbtn.place(x=150,y=300)
        self.exitbtn.place(x=700,y=300)
        self.howtobtn.place(x=410,y=400)
    ...
    def delete_btn(self):#ลบปุม start exit
        ...
        self.howtobtn.destroy()
class page3:
    def __init__(self,canvas):
        self.canvas=canvas
        global back1
        back1=Button(tk,image=photobackbtn,command=homepage)
        self.back1=back1
    def create_back(self):
        print(2)
        self.back1.place(x=870,y=680)
    def deletebtnback(self):
        print(3)
        self.back1.destroy()
...
def play1win():
    canvas.create_image(150,750,anchor=SW,image=Photo1win)
    for i in range(10):
                        tk.update()
                        time.sleep(0.05)
    PlaySound('audio1.WAV', SND_FILENAME)
def play2win():
    canvas.create_image(150,750,anchor=SW,image=Photo2win)
    for i in range(10):
                        tk.update()
                        time.sleep(0.05)
    PlaySound('audio2.WAV', SND_FILENAME)
...
def howtoplaybg():
    canvas.create_image(0,800,anchor=SW,image=photohowtoplay1)
    home.delete_btn()
    page_3=page3(canvas)
    print(55)
    page_3.create_back()
...
startbtnphoto=PhotoImage(file='start55.png')
exitbtnphoto=PhotoImage(file='exit55.png')
startedphoto=PhotoImage(file='dg.png')
howtoplayphoto=PhotoImage(file='howtoplay55.png')
photohowtoplay1=PhotoImage(file='howtoplay1.png')
backbutton=PhotoImage(file='back.png')
dicephoto=PhotoImage(file='dice.png')
photobackbtn=PhotoImage(file='backbtn.png')
...
Phototab=PhotoImage(file='tab111.png')
Phototab1=PhotoImage(file='tab22.png')
Photowalk1=PhotoImage(file='run11.png')
Photowalk2=PhotoImage(file='run22.png')
...
Photo1win=PhotoImage(file='play111win.png')
Photo2win=PhotoImage(file='play22win.png')
page_2=page2(canvas)
page_3=page3(canvas)
homepage()
while True:
